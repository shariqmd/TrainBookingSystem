...
<form:form modelAttribute="booktModel" action="booktkt" id="registeruser" onsubmit="return validationFun()" method="POST" autocomplete="off">
...
<form:input path="trainName" type="text" value="${tname}"    readonly="true" placeholder="Enter Train Name" /><br/>
...
<form:input path="psgName" type="text" id="name" onkeypress="checkNumber();" placeholder="Enter Passenger Name" /><br/>
...
<input type="submit" id="subuser" name="submit" value="Book Now">
